...
Respond in the following JSON format only, no other text:
{
    ...
    "rationale": "two to three sentence explanation written as an inference — use phrases like 'appears to', 'may represent', 'this suggests' rather than stating conclusions. Note if the estimate is based on usage pattern assumptions rather than direct frequency data.",
    "confidence": "High, Medium, or Low",
    "confidence_note": "one sentence explaining what limits confidence (e.g. 'no frequency or usage data available in ticket', 'inferred from trigger conditions only', 'supported by reported incident count')",
